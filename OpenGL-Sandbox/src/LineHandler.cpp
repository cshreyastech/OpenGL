...
LineHandler::LineHandler(const std::string lineHandler, const size_t maxLineCount)
	: MaxLineCount(maxLineCount),
	MaxVertexCount(maxLineCount * VertexOffset), MaxIndexCount(MaxVertexCount)
{
...
const Stats& LineHandler::GetStats()
{
	return RenderStats;
}

void LineHandler::ResetStats()
{
